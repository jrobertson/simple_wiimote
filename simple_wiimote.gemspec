Gem::Specification.new do |s|
  ...
  s.version = '0.6.0'
  s.summary = 'Use this gem with the Wii remote to handle button presses ' + 
      'as well as to individually set LEDs on or off, or to make the ' + 
      'device rumble.'
  s.authors = ['James Robertson']
  s.files = Dir['lib/simple_wiimote.rb']
  s.add_runtime_dependency('pinx', '~> 0.1', '>=0.1.5')
